...
register(id='FrozenLakeDeter-4x4-v0',
         entry_point='gym.envs.toy_text:FrozenLakeEnv',
         kwargs={'map_name' : '4x4', 'is_slippery': False},
         max_episode_steps=100)


register(id='FrozenLakeDeter-8x8-v0',
         entry_point='gym.envs.toy_text:FrozenLakeEnv',
         kwargs={'map_name' : '8x8', 'is_slippery': False},
         max_episode_steps=200)

frozenLake4x4 = gym.make('FrozenLake-v0').env
frozenLake4x4Deter = gym.make('FrozenLakeDeter-4x4-v0').env

frozenLake8x8 = gym.make('FrozenLake8x8-v0').env
frozenLake8x8Deter = gym.make('FrozenLakeDeter-8x8-v0').env
...
##
    ply.plot(np.linspace(0.5, 1, 11), nIte)
    ply.title(descrip + ': Policy Iteration Convergence Time', fontsize=14, fontweight='bold')
...
def QLearningRL(env, descrip,gamma = 0.9):
    ...
    ply.title(descrip + ': QL MeanRewards without DecayRate' , fontsize=14, fontweight='bold')
    ply.xlabel('# of episodes')
    ply.ylabel('Rolling Mean Reward')
    fig1 = ply.gcf()
    #ply.show()
...
if __name__ == '__main__':
     ...
     print("----------------------------- Running FrozenLake4x4 QL  -----------------------------")
     QLearningRL(frozenLake4x4,'FrozenLake4x4')

     print("----------------------------- Running Deterministic FrozenLake4x4 value iteration -----------------------------")
     value_iteration(frozenLake4x4Deter,'FrozenLake4x4Deter')
     print("----------------------------- Running Deterministic FrozenLake4x4 policy iteration -----------------------------")
     policy_iteration(frozenLake4x4Deter,'FrozenLake4x4Deter')
     print("----------------------------- Running Deterministic FrozenLake4x4 QL  -----------------------------")
     QLearningRL(frozenLake4x4Deter,'FrozenLake4x4Deter')

     print("----------------------------- Running FrozenLake8x8 value iteration -----------------------------")
     value_iteration(frozenLake8x8,'FrozenLake8x8')
     print("----------------------------- Running FrozenLake8x8 policy iteration -----------------------------")
     policy_iteration(frozenLake8x8,'FrozenLake8x8')
     print("----------------------------- Running FrozenLake8x8 QL -----------------------------")
     QLearningRL(frozenLake8x8,'FrozenLake8x8')

     print("----------------------------- Running Deterministic FrozenLake8x8 value iteration -----------------------------")
     value_iteration(frozenLake8x8Deter,'FrozenLake8x8-Deterministic')
     print("----------------------------- Running Deterministic FrozenLake8x8 policy iteration -----------------------------")
     policy_iteration(frozenLake8x8Deter,'FrozenLake8x8-Deterministic')
     print("----------------------------- Running Deterministic FrozenLake8x8 QL -----------------------------")
     QLearningRL(frozenLake8x8Deter,'FrozenLake8x8-Deterministic')
